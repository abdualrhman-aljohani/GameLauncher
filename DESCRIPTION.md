...
GameLauncher turns any spot on your Windows screen into a game hub. Press `Ctrl+Alt+G`, pick a game from an animated radial wheel with customizable styles and themes, and play — works with Steam, the Microsoft Store, shortcuts, and more. Native C++, zero bloat.
...
- 6 wheel drawing styles (Ripple, Flame, Neon, Gradient, Aurora, Custom) and 6 ready themes + a Custom theme — fully customizable look
...
**Requirements:**
Windows 10 (2004+) or Windows 11, with WebView2 Runtime (already installed on most modern machines).
